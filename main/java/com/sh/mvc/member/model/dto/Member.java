 ...
 * Entity
 * 
 * - member객체 하나는db member 테이블의 한 행과 매칭
...
public class Member {
	...
	public Member(String memberId, String memberName, Gender gender, Date birthday, String email, String phone,
			String hobby, int point) {
		super();
		this.memberId = memberId;
		this.memberName = memberName;
		this.gender = gender;
